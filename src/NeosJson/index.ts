...
import { Grabbable } from "./Components/Transform/Interaction/Grabbable"
import { StaticTexture2D } from "./Components/Assets/StaticTexture2D"
...
const w = new NeosJson()
const child = w.getRootSlot().addSlot("Child")
child.attachComponent(new Grabbable())
child.attachComponent(new StaticTexture2D({ URL: "@https://pbs.twimg.com/profile_images/1104647239325036544/h4Ny3FsJ_400x400.jpg" }))
